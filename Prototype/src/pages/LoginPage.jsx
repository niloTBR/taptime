  ...
  return (
    <div className="min-h-screen relative flex items-center justify-center">
      ...
      <div 
        ...
        style={{
          backgroundImage: `url('data:image/svg+xml,<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 800 600"><defs><linearGradient id="bg" x1="0%" y1="0%" x2="100%" y2="100%"><stop offset="0%" style="stop-color:%23f0f9ff" /><stop offset="100%" style="stop-color:%23e0f2fe" /></linearGradient></defs><rect width="800" height="600" fill="url(%23bg)" /><circle cx="200" cy="150" r="80" fill="%23a3e635" opacity="0.3" /><circle cx="600" cy="400" r="120" fill="%23fbbf24" opacity="0.2" /></svg>')`
        }}
      />
